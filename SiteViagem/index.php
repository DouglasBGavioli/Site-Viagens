  ...
  <div id="menu" class="container">
    ...
    <div class="row my-4">
      ...
      while ($rows_viagens = mysqli_fetch_assoc($resultado_viagens)) {
        ...
        $result_imagem = "SELECT * FROM arquivo WHERE codigo = $id";
      ...
      ?>
        <div class="col-sm-12 col-md-4 mb-4">
          ...
          <style type="text/css">
            ...
            <img id="viag" class="viag" src="./upload/<?php echo $rows_imagem['arqui'];?>" alt="Imagem do Card">
            <div class="card-body text-center">
              <h4 class="card-title"><?php echo $rows_viagens['titulo']; ?> </h4>
              <p class="card-text">Viagem acontecerá no dia <?php echo $data_br ?></p>
              <a href="viagem.php?id_Viagem=<?php echo $rows_viagens['idViagem']; ?>
              " class="btn btn-primary">Ver mais !!! </a><!-- id_da_Viagem recebe o id_viagem-->
            </div>
          </div>
        </div>
      <?php } ?>
